...
export default function orderShop() {
       ...
       return (
            <div>
            <div>
            <Head title="Study Date" />
                <Formm>
                    <br/>
                    <HeaderTitle Name={"การนัดเรียน"}/>
                  ...
                  <div>
                   ...
                   <Nav vertical pills>
                    ...
                    <h5 style={{marginLeft:"10px",color:"#f0ab66"}}>คำแนะนำ</h5>
                           ...
                           <NavLink href="/User/advice/studyDate" active >การนัดเรียน</NavLink>
                       </NavItem>
                    </Nav>
                    </div>
                </div>
                ...
                <div className="col-lg-10" >
                    ...
                    <Row>
                        <h3 style={{marginTop:"25px",marginLeft:"15px",color:"#525f81"}}>การนัดเรียน:</h3>
                    </Row>
